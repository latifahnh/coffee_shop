...
include '../koneksi.php';
//tampilan tabel
$result=$connect->query('SELECT * FROM tb_supplier');
	    ...
	    <header>
	        <div class="container text-center" style="padding-bottom: 20px">
	            <div class="intro-text">
	                <div class="intro-heading" style="color: white">Daftar Supplier</div>
	                <form action="tambah_supplier.php"><button type="submit" method="post" class=" btn btn-xl" style="color: white"> Tambah Supplier
	                </form>
	            </div>
	        </div>
	    </header>
    <div class="col-md-3" style="padding-bottom: 10px;"><a href="../login/home.php"><button class="btn btn-info btn-info-outline" style="color:#2C0A05;">Kembali</button></a></div>
		...
		<div class="container">		        
			<table class="table table-striped table-bordered jumbotron"style="background-color: rgba(236, 240, 241,0.8);color: #2C0A05;" align="right"  >
			   ...
			   <th class="text-center">Jenis Supplier</th>
			   <th class="text-center">Aksi</th>
				...
				while ($row=$result->fetch_assoc())
				{
				   ...
				   echo "<td align='center'>".$row['id_sup']."</td>";
				   echo "<td>".$row['nama_sup']."</td>";
				   echo "<td>".$row['alm_sup']."</td>";
				   echo "<td>".$row['tlp_sup']."</td>";
				   echo "<td>".$row['jenis_sup']."</td>";
				   echo '<td align="center"><a href="hapus.php?id='.$row['id_sup'].'" onclick="return confirm(\'Anda yakin untuk menghapus?\')"><button class="btn btn-danger btn-danger-outline">Hapus</button></a></td>';			   
			   $no++;
				}
				?>
			</table>
