				    ...
				    <header>
				        <div class="container">
				            <div class="intro-text">
				                <div class="intro-heading"><h3 align="center" style="color: #2C0A05;">Admin Login Here</h3></div>
				            </div>
				        </div>
				    </header>

				    <div class="form-group">
				      <form action="admin_action_input.php" method="post">
					      <div class="form-group">
					        <label style="color: #2C0A05;">Username</label>
					        <input class="form-control" type="text" name="admin_name" placeholder="Username" required oninvalid="this.setCustomValidity('data tidak boleh kosong')" oninput="setCustomValidity('')">
					      </div>    
					      <div class="form-group">
					        <label style="color: #2C0A05;">Password</label>
					        <input class="form-control" type="password" name="admin_pass" placeholder="Password" required oninvalid="this.setCustomValidity('data tidak boleh kosong')" oninput="setCustomValidity('')">
					      </div>
				            <div class="form-group">
				        		<button type="submit" class="btn btn-block btn-xl" style="color: #2C0A05;">Login</button>
				      		</div>  
				      </form>
				    </div>
			    </div>
