			...
			<div class="form-group">
				<form action="aksi_tambah_karyawan.php" method="post">
					<div class="form-group">
						...
						<input class="form-control" type="text" name="id_kar" placeholder="ID Karyawan" required="">
					</div>
					<div class="form-group">
						<label>Kode Karyawan</label>
						<input class="form-control" type="text" name="kode_kar" placeholder="Kode Karyawan" required="">
					</div>	
					<div class="form-group">
						<label>Nama Karyawan</label>
						<input class="form-control" type="text" name="nama_kar" placeholder="Nama Karyawan" required="">
					</div>	
					<div class="form-group">
						<label>Bagian</label>
						<input class="form-control" type="text" name="bagian" placeholder="Bagian" required="">
					</div>	
					<div class="form-group">
						<label>Alamat Karyawan</label>
						<input class="form-control" type="text" name="alm_kar" placeholder="Alamat Karyawan" required="">
					</div>	
					<div class="form-group">
						<label>Telepon Karyawan</label>
						<input class="form-control" type="text" name="tlp_kar" placeholder="Telepon Karyawan" required="">
					</div>		
					...
					<div class="text-center">
						Do you wish to back to <a href="input_karyawan.php">page before</a>?
					</div>	
				</form>
			</div>
		</div>
