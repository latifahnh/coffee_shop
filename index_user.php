...
<nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="background-color: #2C0A05;">
	...
	<!-- header menu -->
  	<div class="navbar-header">
  		  ...
  		  <a class="navbar-brand" href="index_user.php">COFFEE LATEEF</a>
  	</div>
		<!-- daftar item menu -->
...
<div class="container" align="center" id="menu"><br /><br /><br />
  <h3>List Menu</h3>
      ...
      ?>
      <div class="col-md-4">
        <form method="post" action="index_user.php?action=add&id_produk=<?php echo $row["id_produk"]; ?>">
      ...
      <!-- ORDER DETAIL -->
        <div class="container" style="clear: both; text-align: center;"><br/>
          ...
          <div class="table-responsive">
            <table class="table table-striped table-bordered jumbotron">
              ...
              <tr>
                ...
                <td><a href="index_user.php?action=delete&id_produk=<?php echo $values["item_id"]; ?>"><span class="text-danger" style="color: #2C0A05;">Remove</span></a></td>
              </tr>
                <?php
          ...
          <form method="POST" action="konsumen/beli_konsumen.php">
            <input type="submit" style="margin: 10px;" class="btn btn-success" value="Lanjutkan"></input>
          </form>
</div>
<!-- ./produk-list -->
