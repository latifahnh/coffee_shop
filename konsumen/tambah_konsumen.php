	...
	<div class="row">
		<div class="col-md-6 col-md-offset-3 jumbotron " style="background-color: rgba(236, 240, 241,0.5);">
			...
			<div class="form-group">
				<form action="aksi_tambah_konsumen.php" method="post">
					<div class="form-group">
						<label>ID Konsumen</label>
						<input class="form-control" type="text" name="id_kon" placeholder="ID Konsumen" required="">
					</div>
					<div class="form-group">
					...
					<div class="text-center">
						Do you wish to back to <a href="input_konsumen.php">page before</a>?
					</div>	
				</form>
			</div>	
		</div>	
