...
<footer class="parallax-section">
	<div class="container" style="text-align: justify-all;">
			<!-- contain -->
		<div class="container" >
		    <div class="row" style="padding-top: 125px; padding-bottom: 100px;" >
			    <div class="col-md-4 col-md-offset-4 jumbotron" style="background-color: rgba(236, 240, 241,0.5);">
				    <header>
				        <div class="container">
				            <div class="intro-text">
				                <div class="intro-heading"><h3 align="center" style="color: #2C0A05;">Your Password</h3></div>
				            </div>
				        </div>    
				    </header>
